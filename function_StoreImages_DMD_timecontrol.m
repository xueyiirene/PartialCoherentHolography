function [Setup,sequenceid] = function_StoreImages_DMD_timecontrol(Setup, stack, illuminatetime, repeatprojection)
...
%% Repeat sequence
Setup.DMD.SequenceControl.RepeatModeValue=repeatprojection;
...
%% sequence timing
Setup.DMD.illuminatetime=illuminatetime; %Setup.PointCloud.CycleLength/Setup.PointCloud.divider*10^6*0.6;%us
picturetime=0;
triggerdelay=0;
